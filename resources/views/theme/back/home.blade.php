...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2"><img src="{{ asset('assets/back/images/users/1.jpg') }}" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('assets/back/images/users/4.jpg') }}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('assets/back/images/users/5.jpg') }}" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('assets/back/images/users/1.jpg') }}" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Steave"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('assets/back/images/users/2.jpg') }}" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('assets/back/images/users/3.jpg') }}" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="{{ asset('assets/back/images/users/4.jpg') }}" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('assets/back/images/users/1.jpg') }}" alt="user">
                                            </div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('assets/back/images/users/2.jpg') }}" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="{{ asset('assets/back/images/users/3.jpg') }}" alt="user">
                                            </div>
                                            <div class="chat-content">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <p>And is full of waffle to It has multiple paragraphs and is full of waffle to
                                            ...
                                            comment..</p>
                                        <img src="{{ asset('assets/back/images/background/img4.jpg') }}" class="img-fluid">
                                    </div>
                                </div>
    ...
    <script src="{{ asset('assets/back/libs/flot/jquery.flot.time.') }}"></script>
